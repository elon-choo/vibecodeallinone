...
class KnowledgeGraphServer:
    ...
    def __init__(self):
        ...
        # Non-Neo4j components (always available)
    ...
    # --- Proxy properties: delegate to registry for Neo4j-backed components ---
    @property
    def searcher(self):
        return self._registry.searcher

    @property
    def _neo4j_driver(self):
        return self._registry.neo4j_driver

    @property
    def hybrid_search(self):
        return self._registry.hybrid_search

    @property
    def write_back(self):
        return self._registry.write_back

    @property
    def impact_simulator(self):
        return self._registry.impact_simulator

    @property
    def weight_learner(self):
        return self._registry.weight_learner

    @property
    def bug_radar(self):
        return self._registry.bug_radar

    @property
    def auto_test_gen(self):
        return self._registry.auto_test_gen

    @property
    def ontology_evolver(self):
        return self._registry.ontology_evolver

    @property
    def knowledge_transfer(self):
        return self._registry.knowledge_transfer

    @property
    def llm_judge(self):
        return self._registry.llm_judge

    @property
    def vector_search_engine(self):
        return self._registry.vector_search_engine

    @property
    def rag_engine(self):
        return self._registry.rag_engine

    @property
    def doc_generator(self):
        return self._registry.doc_generator

    @property
    def shared_memory(self):
        return self._registry.shared_memory

    @property
    def code_assist(self):
        return self._registry.code_assist
    ...
    async def _index_project(self, args: dict) -> str:
        ...
        # Security: restrict indexing to CWD subtree or user home directory
