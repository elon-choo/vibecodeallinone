---
name: code-reviewer
description: "**CODE REVIEWER** — Automated code review with Quality Gate scoring, code smell detection, and complexity analysis. Activates after Write/Edit tool usage. Use for code review, feedback, quality checks, or analysis requests."
license: MIT
allowed-tools:
  - Read
  - Glob
