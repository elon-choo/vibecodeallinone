...
description: "**NAMING CONVENTION GUARD** — Enforces consistent naming rules for variables, functions, classes, and filenames. Auto-applies camelCase/PascalCase/snake_case per language. Detects bad names and suggests improvements. Activates during code writing."
license: MIT
allowed-tools:
  - Read
  - Glob
